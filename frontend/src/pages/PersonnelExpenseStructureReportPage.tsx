...
const PersonnelExpenseStructureReportPage: React.FC = () => {
  ...
  useEffect(() => {
    filterEmployees()
  }, [employees, selectedStatus, searchQuery, selectedStructure, selectedDepartment])
  ...
  const fetchEmployees = async () => {
    try {
      setLoading(true)
      const response = await api.get(`/employees/structure/${structureId}/with-status`)
  ...
  const getUniqueDepartments = () => {
    const departments = employees.map(emp => emp.department_name)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Список сотрудников структуры "{structureName}" по статусам
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                {getUniqueDepartments().slice(1).map((department) => (
...
export default PersonnelExpenseStructureReportPage 